...
import sip
import tetraDMO_Decoder_v0_epy_block_0 as epy_block_0  # embedded python block
...
import tetraDMO_Decoder_v0_epy_block_0_2 as epy_block_0_2  # embedded python block
...
class tetraDMO_Decoder_v0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "tetraDMO_Decoder_v0.1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tetraDMO_Decoder_v0.1")
        ...
        self.qtgui_time_sink_x_0_0_0.set_y_axis(-0.2, 3.2)
        ...
        self.epy_block_1 = epy_block_1.lowerMac(lib='/home/ctn008/tetraDMO-Receiver/tetraDMO-Decoder/libs/codingLib.so')
        ...
        self.epy_block_0 = epy_block_0.tetraChDecoder(example_param=1.0)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_short*1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/ctn008/tetraDMO-Receiver/tetraDMO-Decoder/tetraDMO_s36kBit_demod_samples.uint8', False, 0, 0)
    ...
    def set_view_step(self, view_step):
        ...
        self.epy_block_0_1_0.step = self.view_step
    ...
    def set_next_view(self, next_view):
        ...
        self.epy_block_0_1_0.change = self.next_view
