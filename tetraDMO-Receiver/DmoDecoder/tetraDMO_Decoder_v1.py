...
class tetraDMO_Decoder_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/von-ubuntu-pc/TETRA-DMO-Transceiver/tetraDMO-Receiver/DmoDecoder/tetraDMO_s36kBit_demod_samples.uint8', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_short*1, '/home/von-ubuntu-pc/TETRA-DMO-Transceiver/tetraDMO-Receiver/out_sound.out', False)
