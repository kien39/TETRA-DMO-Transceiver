...
class tetraDMO_Receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "tetraDMO_Receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tetraDMO_Receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tetraDMO_Receiver")
        ...
        self.frequency_mhz = frequency_mhz = 390
        self.freq_offset_khz = freq_offset_khz = 25
        self.decim = decim = 16
...
def main(top_block_cls=tetraDMO_Receiver, options=None):
