...
import sip
import test_speechDecoder_grc_epy_block_0_2 as epy_block_0_2  # embedded python block



class test_speechDecoder_grc(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "test_speechDecoder_grc", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("test_speechDecoder_grc")
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_speechDecoder_grc")
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_short*1, (samp_rate*6/10), True, 0 if "auto" == "auto" else max( int(float(0.1) * (samp_rate*6/10)) if "auto" == "time" else int(0.1), 1) )
        self.blocks_short_to_float_0 = blocks.short_to_float(1, 32768)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(4)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/ctn008/tetraDMO-Receiver/codec/audio_src_01GEN.cod', False, 0, 0)
        ...
        self.connect((self.epy_block_0_2, 0), (self.blocks_short_to_float_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle2_0.set_sample_rate((self.samp_rate*6/10))
...
def main(top_block_cls=test_speechDecoder_grc, options=None):
